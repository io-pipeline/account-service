...
# Account Service Startup Script
# Port: 38105 (Account Management Service)
# This script helps start the account service in development mode
...
SERVICE_PORT="38105"
DESCRIPTION="User account management and authentication service"
...
set_registration_host "account-service" "PLATFORM_REGISTRATION_HOST"

# Set additional environment variables if needed
# (Account service uses shared infrastructure, so minimal additional config)
